...
# [howto/manual]).
latex_documents = [
    ("index", "TinyDB.tex", "TinyDB Documentation", "Markus Siemens", "manual"),
]
...
man_pages = [("index", "tinydb", "TinyDB Documentation", ["Markus Siemens"], 1)]
...
extlinks = {"issue": ("https://https://github.com/msiemens/tinydb/issues/%s", "issue ")}
